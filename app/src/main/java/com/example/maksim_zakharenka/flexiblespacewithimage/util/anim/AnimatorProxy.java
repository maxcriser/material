package com.example.maksim_zakharenka.flexiblespacewithimage.util.anim;
...
public final class AnimatorProxy extends Animation {
    ...
    private static final Map<View, AnimatorProxy> PROXIES =
            new WeakHashMap<>();
    ...
    private void computeRect(final RectF r, final View view) {
    ...
    private void transformMatrix(final Matrix m, final View view) {
        final float w = view.getWidth();
        final float h = view.getHeight();
